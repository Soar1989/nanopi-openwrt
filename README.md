...
### 下载地址：
https://github.com/Soar1989/nanopi-openwrt/tags  
...
### 终端内在线升级方法：
```bash
wget -qO- https://github.com/Soar1989/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | bash
```
slim版
```bash
wget -qO- https://github.com/Soar1989/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | ver=-slim bash
```
x86安装盘不是sda的情况下使用
```bash
wget -qO- https://github.com/Soar1989/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | disk=sdb bash
```
(脚本由gary lau提供，非常感谢！)
...
### 更新说明：
https://github.com/Soar1989/nanopi-openwrt/blob/master/CHANGELOG.md

#### 本固件NAT基准性能测试：
<img src="https://raw.githubusercontent.com/Soar1989/nanopi-openwrt/master/assets/NAT.jpg" width="450" />
